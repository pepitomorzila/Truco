            ...
            if (b.cantarTruco() == 0)
            {
                if (b.decidirTruco() == 1)
                {
                    ...
                    if (b.cantarTruco() == 0)
                    {
                        ...
                        if (b.cantarTruco() == 0 && truco_check == false)
                        {
                            m.Juego3();
                        ...
                        else if (b.cantarTruco() == 1 && truco_check == false)
                        {
